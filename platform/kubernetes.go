...
func UnSetK8SContext(GRVCluster configuration.ProviderCluster) error {
	...
	_, ok := config.Clusters[fmt.Sprintf("%s_%s_%s", GRVCluster.Project, GRVCluster.Name, GRVCluster.Region)]
	if ok {
		delete(config.Clusters, fmt.Sprintf("%s_%s_%s", GRVCluster.Project, GRVCluster.Name, GRVCluster.Region))
	}

	_, ok = config.Contexts[fmt.Sprintf("%s_%s_%s", GRVCluster.Project, GRVCluster.Name, GRVCluster.Region)]
	if ok {
		delete(config.Contexts, fmt.Sprintf("%s_%s_%s", GRVCluster.Project, GRVCluster.Name, GRVCluster.Region))
	}

	_, ok = config.AuthInfos[fmt.Sprintf("%s_%s_%s", GRVCluster.Project, GRVCluster.Name, GRVCluster.Region)]
	if ok {
		delete(config.AuthInfos, fmt.Sprintf("%s_%s_%s", GRVCluster.Project, GRVCluster.Name, GRVCluster.Region))
	}
...
// Setcontext update the file ~/.kube/config with the context associate with teh cluster.
func SetK8SContext(GRVCluster configuration.ProviderCluster) error {
	...
	context.Cluster = fmt.Sprintf("%s_%s_%s", GRVCluster.Project, GRVCluster.Name, GRVCluster.Region)
	context.AuthInfo = fmt.Sprintf("%s_%s_%s", GRVCluster.Project, GRVCluster.Name, GRVCluster.Region)
	...
	config.Clusters[fmt.Sprintf("%s_%s_%s", GRVCluster.Project, GRVCluster.Name, GRVCluster.Region)] = cluster
	config.Contexts[fmt.Sprintf("%s_%s_%s", GRVCluster.Project, GRVCluster.Name, GRVCluster.Region)] = context
	config.AuthInfos[fmt.Sprintf("%s_%s_%s", GRVCluster.Project, GRVCluster.Name, GRVCluster.Region)] = K8SAuthInfo
	config.CurrentContext = fmt.Sprintf("%s_%s_%s", GRVCluster.Project, GRVCluster.Name, GRVCluster.Region)
